...
router.get("/orders/unseen-count", requireAdmin, adminController.unseenOrderCount);
router.post("/orders/mark-all-seen", requireAdmin, adminController.markAllSeen);
router.post("/orders/:id/seen", requireAdmin, adminController.markSeen);
...
router.patch("/users/:id/tag", requireAdmin, adminController.saveUserTag);
router.get("/collection", requireAdmin, adminController.collection);
router.get("/weekly-orders", requireAdmin, adminController.weeklyOrders);
router.post("/weekly-orders", requireAdmin, adminController.addWeeklyOrder);
