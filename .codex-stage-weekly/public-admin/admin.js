(function () {
  ...
  function renderPickupSettings() {
      ...
      return `
        <details class="collapsible-section pickup-settings-card">
          <summary class="collapsible-summary">
            <span class="settings-summary-copy"><strong>自提地点与时间设置</strong><small>低频配置 · 默认折叠 — 还没有自提点数据</small></span>
          </summary>
        </details>
      `;
    }
    ...
    return `
      <details class="collapsible-section pickup-settings-card">
        <summary class="collapsible-summary">
          <span class="settings-summary-copy"><strong>自提地点与时间设置</strong><small>低频配置 · 默认折叠 — 控制本周前端显示的地点</small></span>
        </summary>
    ...
    return `
      <section class="weekly-overview-card">
        <div class="weekly-overview-copy">
          ...
          <p class="weekly-editor-desc">始终可见 · 开放状态与倒计时一眼看清</p>
        </div>
      ...
      <section class="section-block weekly-products-section">
        <div class="weekly-products-head">
          <div>
            <p class="eyebrow">Weekly Products</p>
            <h2 class="section-heading">本周产品</h2>
            <p class="weekly-editor-desc">高频编辑 · 默认展开，放在主操作位</p>
          </div>
          <div class="weekly-products-actions">
      ...
      <details class="collapsible-section weekly-base-settings">
        <summary class="collapsible-summary">
          <span class="settings-summary-copy"><strong>团购基础设置</strong><small>低频配置 · 默认折叠 — 标题、起止时间、自动关闭规则</small></span>
        </summary>
      ...
      <details class="weekly-create-card weekly-create-card--bottom">
        <summary class="weekly-create-summary">
          ...
          <div class="weekly-create-text">
            ...
            <div class="weekly-create-sub">谨慎操作 · 单独放在底部，创建前二次确认 — 在当前基础上新建，编号自动 +1</div>
          </div>
