...
const checks = [
  ...
  ["本周产品主操作区", js, ["weekly-products-section", "data-weekly-products-toggle", "高频编辑 · 默认展开", "data-current-product-form", "saveCurrentProduct(currentProductForm)"]],
  ["团购低频设置默认折叠", js, ["<details class=\"collapsible-section weekly-base-settings\">", "低频配置 · 默认折叠", "自提地点与时间设置"]],
  ["创建新一期置底并二次确认", js, ["weekly-create-card--bottom", "data-next-title", "确认创建", "现有订单会保留在历史团购"]],
  ["本周团购参考图响应式布局", css, [".weekly-overview-card", ".weekly-countdown-boxes", ".weekly-products-head", ".weekly-create-card--bottom", "@media (max-width: 720px)"]],
