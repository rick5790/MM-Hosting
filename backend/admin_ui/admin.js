  ...
  function renderInlineOrderExpanded(order) {
    return `
      <div class="order-inline-body">
        ...
        ` : ""}
        <form class="order-inline-form" data-inline-form="status" data-order-id="${escapeHtml(order.id)}">
          <div class="order-inline-form-row">
            ...
            <button class="button-secondary" type="submit" style="white-space:nowrap;font-size:13px;">保存状态</button>
          </div>
        </form>
        <form class="order-inline-form" data-inline-form="payment" data-order-id="${escapeHtml(order.id)}">
          <div class="order-inline-form-row">
            <select class="select" name="payment_status" style="flex:1;font-size:13px;">
            ...
            <button class="button-secondary" type="submit" style="white-space:nowrap;font-size:13px;">保存付款</button>
          </div>
        </form>
        <form class="order-inline-form" data-inline-form="comment" data-order-id="${escapeHtml(order.id)}">
          <textarea class="textarea" name="admin_comment" rows="2" style="font-size:13px;" placeholder="管理员备注（顾客不可见）">${escapeHtml(order.admin_comment || "")}</textarea>
          <div class="order-inline-form-row" style="margin-top:8px;">
            <button class="button-secondary" type="submit" style="font-size:13px;">保存备注</button>
          </div>
        </form>
      </div>
    `;
